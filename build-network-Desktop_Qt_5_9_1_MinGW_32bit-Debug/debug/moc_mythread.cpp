...
QT_MOC_LITERAL(1, 9, 14), // "port_connected"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "over"
QT_MOC_LITERAL(4, 30, 8) // "progress"

    },
    "Mythread\0port_connected\0\0over\0progress"
};
...
void Mythread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->port_connected((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        ...
        {
            typedef void (Mythread::*_t)(QString , int , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Mythread::port_connected)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Mythread::over)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Mythread::port_connected(QString _t1, int _t2, QString _t3)
{
