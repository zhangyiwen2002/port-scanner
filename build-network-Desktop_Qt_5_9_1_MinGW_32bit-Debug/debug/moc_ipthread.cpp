...
void IpThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        IpThread *_t = static_cast<IpThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (IpThread::*_t)(QString , int , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IpThread::ip_connected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (IpThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IpThread::over)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (IpThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IpThread::progress)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject IpThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_IpThread.data,
      qt_meta_data_IpThread,  qt_static_metacall, nullptr, nullptr}
};
...
void *IpThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IpThread.stringdata0))
        return static_cast<void*>(const_cast< IpThread*>(this));
